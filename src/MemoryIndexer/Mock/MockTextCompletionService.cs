...
public sealed partial class MockTextCompletionService : ITextCompletionService
{
    ...
    {
        _logger = logger;
        LogMockTextCompletionServiceActive(_logger);
    }
    ...
    [LoggerMessage(Level = LogLevel.Warning, Message = "MockTextCompletionService is active - responses are fixed placeholders, not generated by an LLM. Configure a real ITextCompletionService for production use.")]
    private static partial void LogMockTextCompletionServiceActive(ILogger logger);
